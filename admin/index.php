...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost","root","","celyncell");
...
<head>
    ...
    <title>Admin Toko Celyn Cell</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Celyn Cell</a> 
            </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=produk"><i class="fa fa-tag"></i>Ticket</a></li>
                    <li><a href="index.php?halaman=news"><i class="fa fa-tag"></i>News</a></li>
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i>Transaksi</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
              ...
              if (isset($_GET['halaman']))
              {
                ...
                elseif ($_GET['halaman']=="tambahnews")
                {
                ...
                elseif ($_GET['halaman']=="hapusnews")
                {
                    include 'hapusnews.php';
                }
                elseif ($_GET['halaman']=="editproduk")
                {
                    include 'editproduk.php';
                }
                elseif ($_GET['halaman']=="editnews")
                {
